...
info.update = function (props) {
    this._div.innerHTML = '<h4>UK total patients</h4>' +  (props ?
        '<b>' + props.name + '</b><br />' + props.healthcare + ' cases'
        : 'Hover over a rigion');
};
info.addTo(map);
...
function ColorByCases(features) {
    return {
        fillColor: getColorByCases(features.properties.healthcare),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
...
region_cases.onAdd = function (map) {
    ...
    var div = L.DomUtil.create('div', 'info legend'),
         ...
         */
        levels = [0,2000, 3000, 4000, 5000, 6000],
        /**
         * @global
         * @type {Array}
