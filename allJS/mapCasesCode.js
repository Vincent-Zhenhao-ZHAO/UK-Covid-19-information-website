...
/**
 * @param map - map 
 * @description this is to creat DOM on html.
 */
 ...
 * @description this is to update the content in the html.
 */
info.update = function (props) {
    this._div.innerHTML = '<h4>UK total cases</h4>' +  (props ?
 ...
 * @description give areas different colors depends on the number of cases. Source from: https://leafletjs.com/examples/geojson/
 * 
 */
function getColorByCases(n){
    return n > 500000 ? '#800025' :
            n > 400000  ? '#BD0025' :
            n > 300000  ? '#E31A0C' :
            n > 200000  ? '#FC4E1A' :
            n > 100000   ? '#FD8D4C' :
...
function ColorByCases(features) {
    return {
        fillColor: getColorByCases(features.properties.cases),
        weight: 2,
        opacity: 1,
        color: 'white',
        dashArray: '3',
...
region_cases.onAdd = function (map) {
    ...
    var div = L.DomUtil.create('div', 'info legend'),
         ...
         */
        levels = [0,100000, 200000, 300000, 400000, 500000],
        /**
         * @global
         * @type {Array}
